...
<body>
    ...
    <div class="tudo">
        <div class="sabores">
            <h3>Calabresa</h3>
            <h4>Molho, mussarela, calabresa, azeitona e orégano</h4>

            <h3>Quatro queijos</h3>
            <h4>Queijo gorgonzola, queijo parmesão, queijo mussarela, requeijão, bacon, mel</h4>

            <h3>Portuguesa</h3>
            <h4>Mussarela, presunto, ervilha, palmito, calabresa, cebola, ovo, bacon, tomate, azeitona, milho</h4>

            <h3>Frango com catupiry</h3>
            <h4>Mussarela, frango, catupiry e tomate</h4>

            <h3>Marguerita</h3>
            <h4>Mussarela, tomate, manjericão</h4>

            <h3>Mussarela</h3>
            <h4>Mussarela, óregano e azeitona</h4>

            <h3>Brigadeiro com Morango</h3>
            <h4>Morango, brigadeiro</h4>
        </div>

        <div class="info">
            <form action="quantidadepizza.php" method="post">
